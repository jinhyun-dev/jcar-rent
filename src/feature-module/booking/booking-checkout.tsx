              ...
              <div className="col-lg-8">
                <div className="booking-information-main">
                  <form>
                          ...
                          <li>
                            <label className="booking_custom_check">
                              <input
                                ...
                                checked={tab === 'delivery'}
                                onChange={()=>setTab('delivery')}
                              />
                    ...
                    <div className={`booking-information-card delivery-location ${tab === 'delivery' ?'d-block': 'd-none' }`}>
                      <div className="booking-info-head">
                        <span>
                          <i className="bx bxs-car-garage" />
                        </span>
                    ...
                    <div className={`booking-information-card pickup-location ${tab === 'pickup' ? 'd-block':'d-none'}`}>
                      <div className="booking-info-head">
                        <span>
                          <i className="bx bxs-car-garage" />
                        </span>
