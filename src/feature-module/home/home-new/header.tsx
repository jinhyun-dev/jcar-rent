...
const NewHeader = () => {
  ...
  return (
    <>
      <header className={`header ${scrolled ? "header-fixed" : ""} header-four`}>
          ...
          <nav className="navbar navbar-expand-lg header-nav">
            ...
            <ul className="nav header-navbar-rht">
						<li className="nav-item user-link">
							<Link className="nav-link btn-secondary btn d-inline-flex align-items-center" to={all_routes.login}><i className="bx bx-user me-1"></i>Sign In</Link>
						</li>
						<li className="nav-item">
							<Link className="nav-link header-reg  d-inline-flex align-items-center" to={all_routes.register}><span><i className="bx bx-lock"></i></span>Sign Up</Link>
						</li>
					</ul>
