...
import { reservationsData } from "../../../common/json/reservationsList";
...
const ReservationsList = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (text: string) => (
        <span
          className={`badge  ${text === "Completed" ? "bg-success-transparent" : text === "Confirmed" ? "bg-orange-transparent" : text === "In Rental" ? "bg-violet-transparent" : "bg-danger-transparent"} d-inline-flex align-items-center badge-sm `}
        >
        ...
        <div className="dropdown">
          ...
          <ul className="dropdown-menu dropdown-menu-end p-2">
            ...
            <li>
              <Link
                className="dropdown-item rounded-1"
                to={all_routes.adminEditReservations}
              >
