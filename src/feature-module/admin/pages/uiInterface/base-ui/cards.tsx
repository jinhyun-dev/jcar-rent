      ...
      <div className="content">
        ...
        <div className="row">
          <div className="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
            <div className="card">
              <ImageWithBasePath
                src="assets/admin/media/img/img-01.jpg"
          ...
          <div className="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
            ...
            <div className="card">
              ...
              <div className="card-footer">
                ...
                <Link to="#" className="card-link text-success m-1">
                  <u>Review</u>
                </Link>
              </div>
            </div>
          ...
          <div className="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
            <div className="card">
              <ImageWithBasePath
                src="assets/admin/img/media/img-02.jpg"
                className="card-img-top"
                alt="..."
              />
              <div className="card-body">
          ...
          <div className="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
            <div className="card">
              <ImageWithBasePath
                src="assets/admin/img/media/img-03.jpg"
                className="card-img-top"
                alt="..."
              />
              <div className="card-body">
            ...
            <div className="row row-cols-12">
              <div className="col">
                <div className="card">
                  <div className="card-body">
                    <ImageWithBasePath
                      src="assets/admin/img/media/img-04.jpg"
              ...
              <div className="col">
                <div className="card">
                  <div className="card-body">
                    <ImageWithBasePath
                      src="assets/admin/img/media/img-05.jpg"
                      className="card-img mb-3"
                      alt="..."
                    />
                  ...
                  <div className="card-body">
                    <div className="mb-2">
                      <span className="avatar avatar-md">
                        <ImageWithBasePath
                          src="assets/admin/img/media/img-01.jpg"
                          alt="img"
                        />
                      </span>
                    </div>
        ...
        <div className="row">
          ...
          <div className="col-xl-2">
            <div className="card">
              <div className="card-body">
                <ImageWithBasePath
                  src="assets/admin/img/media/img-1.jpg"
                  className="card-img mb-3"
                  alt="..."
                />
          ...
          <div className="col-xl-2">
            <div className="card">
              <div className="card-body">
                <ImageWithBasePath
                  src="assets/admin/img/media/img-2.jpg"
                  className="card-img mb-3"
                  alt="..."
                />
                <h6 className="card-title fw-semibold mb-3">
                  Hills
                  <span className="badge bg-secondary float-end fs-10">
                    Hot
                  </span>
                </h6>
                <p className="card-text">
          ...
          <div className="col-xl-2">
            <div className="card">
              <div className="card-body">
                <ImageWithBasePath
                  src="assets/admin/img/media/img-3.jpg"
                  className="card-img mb-3"
                  alt="..."
                />
                <h6 className="card-title fw-semibold mb-3">
        ...
        <div className="row">
          ...
          <div className="col-xl-4">
            <div className="card overlay-card">
              <ImageWithBasePath
                src="assets/admin/img/media/img-4.jpg"
                className="card-img"
                alt="..."
              />
              <div className="card-img-overlay d-flex flex-column p-0">
              ...
              <div className="card-body">
                <div className="d-flex align-items-center w-100">
                  <div className="me-2">
                    <span className="avatar avatar-rounded">
                      <ImageWithBasePath
                        src="assets/admin/img/profiles/avatar-11.jpg"
                        alt="img"
                      />
                    </span>
                  </div>
              ...
              <div className="card-body">
                <div className="d-flex align-items-center w-100">
                  ...
                  <div className="">
                    ...
                    <p className="mb-0 text-muted op-7 fs-12">
                      Finished by 24,Nov
                    </p>
                  </div>
                  <div className="ms-auto">
            ...
            <div className="card card-bg-dark">
              <div className="card-body">
                <div className="d-flex align-items-center w-100">
                  ...
                  <div className="">
                    <div className="fs-15 fw-semibold text-white">
                      Pope Adam
                    </div>
            ...
            <div className="card border border-warning">
              <div className="card-body">
                ...
                <div className="avatar-list-stacked">
                  ...
                  <span className="avatar avatar-sm avatar-rounded">
                    <ImageWithBasePath
                      src="assets/admin/img/profiles/avatar-09.jpg"
                      alt="img"
                    />
                  </span>
                </div>
            ...
            <div className="card border border-info">
              <div className="card-body">
                ...
                <div className="avatar-list-stacked">
                  <span className="avatar avatar-sm avatar-rounded">
                    <ImageWithBasePath
                      src="assets/admin/img/profiles/avatar-10.jpg"
                      alt="img"
                    />
                  </span>
                  <span className="avatar avatar-sm avatar-rounded">
            ...
            <div className="card border border-danger">
              <div className="card-body">
                ...
                <div className="avatar-list-stacked">
                  <span className="avatar avatar-sm avatar-rounded">
                    <ImageWithBasePath
                      src="assets/admin/img/profiles/avatar-13.jpg"
                      alt="img"
                    />
                  </span>
                </div>
            ...
            <div className="card border border-light">
              <div className="card-body">
                ...
                <div className="avatar-list-stacked">
                  <span className="avatar avatar-sm avatar-rounded">
                    <ImageWithBasePath
                      src="assets/admin/img/profiles/avatar-16.jpg"
                      alt="img"
                    />
                  </span>
                  <span className="avatar avatar-sm avatar-rounded">
                    <ImageWithBasePath
                      src="assets/admin/img/profiles/avatar-17.jpg"
                      alt="img"
                    />
                  </span>
                  <span className="avatar avatar-sm avatar-rounded">
                  ...
                  <div className="row g-0">
                    <div className="col-md-8">
                      <div className="card-body">
                        ...
                        <p className="card-text mb-0">
                          This is a wild animal with supporting tactics and are
                          very efficient at kill,they are very Dangerous.
                        </p>
                        <p className="mb-0 card-text">
                    ...
                    <div className="col-md-4">
                      <ImageWithBasePath
                        src="assets/admin/img/media/img-5.jpg"
