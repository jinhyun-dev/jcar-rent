  ...
  <div className="content pb-0 me-4">
    ...
    <div className="row">
          ...
          <div className="card-body">
            ...
            >
              <div className="avatar avatar-sm me-3 avatar-rounded">
                <ImageWithBasePath src="assets/admin/img/profiles/avatar-01.jpg" alt="img" />
              </div>
            ...
            >
              <div className="avatar avatar-sm me-3 avatar-rounded">
                <ImageWithBasePath src="assets/admin/img/profiles/avatar-03.jpg" alt="img" />
              </div>
            ...
            >
              <div className="avatar avatar-sm me-3 avatar-rounded">
                <ImageWithBasePath src="assets/admin/img/profiles/avatar-04.jpg" alt="img" />
              </div>
            ...
            >
              <div className="avatar avatar-sm me-3 avatar-rounded">
                <ImageWithBasePath src="assets/admin/img/profiles/avatar-05.jpg" alt="img" />
              </div>
            ...
            >
              <div className="avatar avatar-sm me-3 avatar-rounded">
                <ImageWithBasePath src="assets/admin/img/profiles/avatar-06.jpg" alt="img" />
              </div>
            ...
            >
              <div className="avatar avatar-sm me-3 avatar-rounded">
                <ImageWithBasePath src="assets/admin/img/profiles/avatar-07.jpg" alt="img" />
              </div>
      ...
      <div className="col-xl-6">
        <div className="card">
          <div className="card-header justify-content-between">
            <div className="card-title">Alerts With Different size Images</div>
          </div>
          <div className="card-body">
            <div
