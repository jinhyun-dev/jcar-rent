                                    ...
                                    >
                                        <li className="nav-item" role="presentation">
                                            <button
                                                ...
                                                aria-selected="true"
                                            >
                                                <i className="feather icon-gift me-1 align-middle" />
                                                Ordered
                                            </button>
                                        </li>
                                        <li className="nav-item" role="presentation">
                                            <button
                                                ...
                                                aria-selected="false"
                                            >
                                                <i className="feather icon-check me-1 align-middle" />
                                                Confirmed
                                            </button>
                                        </li>
                                        <li className="nav-item" role="presentation">
                                            <button
                                                ...
                                                aria-selected="false"
                                            >
                                                <i className="feather icon-shopping-bag me-1 align-middle" />
                                                Shipped
                                            </button>
                                        </li>
                                        <li className="nav-item" role="presentation">
                                            <button
                                                ...
                                                aria-selected="false"
                                            >
                                                <i className="feather icon-truck me-1 align-middle" />
                                                Delivery
                                            </button>
                                        </li>
                                    </ul>
                                    ...
                                    >
                                        <li className="nav-item" role="presentation">
                                            <button
                                                ...
                                                aria-selected="true"
                                            >
                                                <i className="feather icon-gift me-1 align-middle d-inline-block" />
                                                Products
                                            </button>
                                        </li>
                                        <li className="nav-item" role="presentation">
                                            <button
                                                ...
                                                aria-selected="false"
                                            >
                                                <i className="feather icon-file me-1 align-middle d-inline-block" />
                                                Sales
                                            </button>
                                        </li>
                                        <li className="nav-item" role="presentation">
                                            <button
                                                ...
                                                aria-selected="false"
                                            >
                                                <i className="feather icon-file-text me-1 align-middle d-inline-block" />
                                                Profit
                                            </button>
                                        </li>
                                        <li className="nav-item" role="presentation">
                                            <button
                                                ...
                                                aria-selected="false"
                                            >
                                                <i className="feather icon-file-minus me-1 align-middle d-inline-block" />
                                                Expenses
                                            </button>
                                        </li>
                                    </ul>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <th scope="row">
                                                                <span className="avatar avatar-sm">
                                                                    <ImageWithBasePath
                                                                        src="assets/admin/img/products/product49.jpg"
                                                                        alt="img"
                                                                    />
                                                                </span>
                                                            </th>
                                                        ...
                                                        <tr>
                                                            <th scope="row">
                                                                <span className="avatar avatar-sm">
                                                                    <ImageWithBasePath
                                                                        src="assets/admin/img/products/product28.jpg"
                                                                        alt="img"
                                                                    />
                                                                </span>
                                                            </th>
                                                        ...
                                                        <tr>
                                                            <th scope="row">
                                                                <span className="avatar avatar-sm">
                                                                    <ImageWithBasePath
                                                                        src="assets/admin/img/products/product60.jpg"
                                                                        alt="img"
                                                                    />
                                                                </span>
                                                            </th>
                                        ...
                                        <div className="col-md-3">
                                            ...
                                            >
                                                <button
                                                    ...
                                                    aria-selected="true"
                                                >
                                                    <i className="feather icon-user me-1 align-middle d-inline-block" />
                                                    Profile
                                                </button>
                                                <button
                                                    ...
                                                    aria-selected="false"
                                                >
                                                    <i className="feather icon-monitor me-1 align-middle d-inline-block" />
                                                    Password
                                                </button>
                                                <button
                                                    className="nav-link text-start"
                                                    ...
                                                    aria-selected="false"
                                                >
                                                    <i className="feather icon-users me-1 align-middle d-inline-block" />
                                                    Team
                                                </button>
                                                <button
                                                    className="nav-link text-start"
                                                ...
                                                <button
                                                    ...
                                                    aria-selected="false"
                                                >
                                                    <i className="feather icon-mail me-1 align-middle d-inline-block" />
                                                    Email
                                                </button>
                                            </div>
                                        </div>
                                                    ...
                                                    <div className="d-sm-flex">
                                                        <div className="me-3">
                                                            <span className="avatar avatar-xxl">
                                                                <ImageWithBasePath src="assets/admin/img/profiles/avatar-02.jpg" alt="img" />
                                                            </span>
                                                        </div>
                                                        <div>
                                                            <div className="my-md-auto mt-4 ms-md-3">
                                                                ...
                                                                <p className="text-muted ms-0 mb-2">
                                                                    ...
                                                                    <span>spruko.space@example.com</span>
                                                                </p>
                                                                <p className="text-muted ms-0 mb-2">
                                                                    <span>
                                            ...
                                            >
                                                <li className="nav-item">
                                                    <Link
                                                        ...
                                                        aria-selected="true"
                                                    >
                                                        <i className="feather icon-user me-2 align-middle d-inline-block" />
                                                        Employees
                                                    </Link>
                                                </li>
                                                <li className="nav-item">
                                                    <Link
                                                        ...
                                                        aria-selected="true"
                                                    >
                                                        <i className="feather icon-users me-2 align-middle d-inline-block" />
                                                        Customers
                                                    </Link>
                                                </li>
                                                <li className="nav-item">
                                                    <Link
                                                        ...
                                                        aria-selected="true"
                                                    >
                                                        <i className="feather icon-gift me-2 align-middle d-inline-block" />
                                                        Products
                                                    </Link>
                                                </li>
                                            </ul>
