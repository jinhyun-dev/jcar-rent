...
import { blogCategoriesData } from "../../../common/json/blogCategoriesList";
...
const BlogCategoriesList = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      sorter: (a: any, b: any) =>
        a.NUMBEROFBLOGS.length - b.NUMBEROFBLOGS.length,
    },
    {
      title: "CREATED DATE",
      dataIndex: "CREATEDDATE",
      render: (text: string) => <span className="text-gray-9">{text}</span>,
            ...
            <nav>
              <ol className="breadcrumb mb-0">
                <li className="breadcrumb-item">
                  <Link to={all_routes.adminBlogCategoriesList}>Home</Link>
                </li>
          ...
          <div className="modal-content">
            ...
            <div className="modal-footer">
              <div className="d-flex justify-content-center">
                ...
                <Link
                  to={all_routes.adminFaqCategoryList}
