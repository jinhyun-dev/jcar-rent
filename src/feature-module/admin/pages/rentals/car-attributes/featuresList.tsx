...
import { featuresData } from "../../../common/json/featuresList";
...
const FeaturesList = () => {
  ...
  const columns = [
    {
      ...
      sorter: (a: any, b: any) => a.FEATURE.length - b.FEATURE.length,
    },
    {
      title: "STATUS",
      dataIndex: "STATUS",
  ...
  return (
    <>
        ...
        <div className="modal-dialog modal-dialog-centered modal-md">
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="mb-0">Create Feature</h5>
              <button
                type="button"
      ...
      {/* Delete Type */}
      <div className="modal fade" id="delete_feature">
        <div className="modal-dialog modal-dialog-centered modal-sm">
          <div className="modal-content">
            <div className="modal-body text-center">
              ...
              <h4 className="mb-1">Delete Feature</h4>
              <p className="mb-3">Are you sure you want to delete feature?</p>
              <div className="d-flex justify-content-center">
                <Link
                  to="#"
                  className="btn btn-light me-3"
