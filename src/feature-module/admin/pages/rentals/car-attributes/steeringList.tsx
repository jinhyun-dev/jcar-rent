...
import { steeringData } from "../../../common/json/steeringList";
import CommonDatatable from "../../../common/dataTable";

const SteeringList = () => {
  const data = steeringData;
  ...
  const columns = [
    {
      ...
      sorter: (a: any, b: any) => a.STEERINGTYPE.length - b.STEERINGTYPE.length,
    },
    {
      title: "STATUS",
      dataIndex: "STATUS",
    ...
    <>
        ...
        <div className="modal-dialog modal-dialog-centered modal-md">
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="mb-0">Create Steering Type</h5>
              <button
                type="button"
            ...
            <div className="modal-body pb-1">
              <div className="mb-3">
                <label className="form-label">
                  Steering Type <span className="text-danger">*</span>
                </label>
      ...
      <div className="modal fade" id="edit_steering">
        <div className="modal-dialog modal-dialog-centered modal-md">
          <div className="modal-content">
            <div className="modal-header">
              <h4 className="mb-0">Edit Steering Type</h4>
              <button
                type="button"
                className="btn-close custom-btn-close"
                data-bs-dismiss="modal"
