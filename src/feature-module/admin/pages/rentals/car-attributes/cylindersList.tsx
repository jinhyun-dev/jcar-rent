...
import { cylindersData } from "../../../common/json/cylindersList";
import CommonDatatable from "../../../common/dataTable";
import { all_routes } from "../../../../router/all_routes";

const CylindersList = () => {
  const data = cylindersData;
  ...
  const columns = [
    {
      ...
      sorter: (a: any, b: any) => a.CYLINDERTYPE.length - b.CYLINDERTYPE.length,
    },
    {
      title: "STATUS",
      dataIndex: "STATUS",
    ...
    <>
        ...
        <div className="modal-dialog modal-dialog-centered modal-md">
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="mb-0">Add Cylinder Type</h5>
              <button
                type="button"
            ...
            <div className="modal-body pb-1">
              <div className="mb-3">
                <label className="form-label">
                  Cylinder Type <span className="text-danger">*</span>
                </label>
      ...
      <div className="modal fade" id="edit_cylinder_type">
        <div className="modal-dialog modal-dialog-centered modal-md">
          <div className="modal-content">
            <div className="modal-header">
              <h4 className="mb-0">Edit Cylinder Type</h4>
              <button
                type="button"
                className="btn-close custom-btn-close"
                data-bs-dismiss="modal"
        ...
        <div className="modal-dialog modal-dialog-centered modal-sm">
          <div className="modal-content">
            <div className="modal-body text-center">
              ...
              <h4 className="mb-1">Delete Cylinder Type</h4>
              <p className="mb-3">Are you sure you want to cylinder type?</p>
              <div className="d-flex justify-content-center">
                <Link
                  to="#"
                  className="btn btn-light me-3"
