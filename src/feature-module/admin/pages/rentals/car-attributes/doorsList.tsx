...
import { doorsData } from "../../../common/json/doorsList";
import CommonDatatable from "../../../common/dataTable";
import { all_routes } from "../../../../router/all_routes";

const DoorsList = () => {
  const data = doorsData;
  ...
  const columns = [
    {
      ...
      sorter: (a: any, b: any) => a.DOORTYPE.length - b.DOORTYPE.length,
    },
    {
      title: "STATUS",
      dataIndex: "STATUS",
          ...
          <ul className="dropdown-menu dropdown-menu-end p-2">
            ...
            <li>
              <Link
                ...
                to="#"
                data-bs-toggle="modal"
                data-bs-target="#delete_door_type"
              >
            ...
            <div className="modal-body pb-1">
              <div className="mb-3">
                <label className="form-label">
                  Door Type <span className="text-danger">*</span>
                </label>
