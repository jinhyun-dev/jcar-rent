...
import { seatsData } from "../../../common/json/seatsList";
  ...
  const columns = [
    {
      ...
      sorter: (a: any, b: any) => a.SEATTYPE.length - b.SEATTYPE.length,
    },
    {
      title: "STATUS",
      dataIndex: "STATUS",
    ...
    <>
        ...
        <div className="modal-dialog modal-dialog-centered modal-md">
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="mb-0">Create Seat Type</h5>
              <button
                type="button"
      ...
      <div className="modal fade" id="edit_seat_type">
        <div className="modal-dialog modal-dialog-centered modal-md">
          <div className="modal-content">
            <div className="modal-header">
              <h4 className="mb-0">Edit Seat Type</h4>
              <button
                type="button"
                className="btn-close custom-btn-close"
                data-bs-dismiss="modal"
        ...
        <div className="modal-dialog modal-dialog-centered modal-sm">
          <div className="modal-content">
            <div className="modal-body text-center">
              ...
              <h4 className="mb-1">Delete Seat Type</h4>
              <p className="mb-3">Are you sure you want to seat type?</p>
              <div className="d-flex justify-content-center">
                <Link
                  to="#"
                  className="btn btn-light me-3"
