...
import { Customer, Driver, PickupLocation, RentalType, ReturnLocation, Tarrif } from '../json/selectOption';
...
const CalenderModal = () => {
  ...
  return (
    <>
  {/* Event */}
  <div className="modal fade" id="add_booking">
    <div className="modal-dialog modal-lg modal-dialog-centered">
      <div className="modal-content">
        <div className="modal-header">
          <h4 className="d-inline-flex align-items-center">Create Booking</h4>
          <button
            type="button"
                                  ...
                                  <div className="row gy-3">
                                    <div className="col-md-4">
                                      <div>
                                        <p className="mb-1">Color</p>
                                        <h6 className="fs-14 d-inline-flex align-items-center">
                                          <i className="ti ti-square-filled text-info me-1" />
                                          Blue
                                        </h6>
                                      </div>
                                    </div>
                                ...
                                >
                                  ...
                                  <span className="d-block text-info">
                                    ...
                                    <i
                                      ...
                                      data-bs-toggle="tooltip"
                                      data-bs-placement="top"
                                      data-bs-original-title="Quick assistance for unexpected breakdowns"
                                    />
                                  </span>
                                </label>
                                <div className="text-end">
  ...
  {/* /Event */}
  {/* Completed */}
      <Modal show={showEventDetailsModal} size='sm' centered={true} onHide={handleEventDetailsClose}>
        <div className="modal-body text-center">
          <form >
            ...
            <div className="d-flex justify-content-center">
              <Link onClick={handleEventDetailsClose} to='#' className="btn btn-primary w-100">
                View Details
              </Link>
            </div>
          </form>
