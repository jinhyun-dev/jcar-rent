...
import { userBookingInprogressData } from "../../core/data/json/user-booking-inprogress";
...
export const UserBookingInprogress = () => {
  ...
  const [userBookingInprogress, setUserBookingInprogress] = useState([]);
  const [searchInput, setSearchInput] = useState("");
  const filteredData = userBookingInprogress.filter((booking) => {
  ...
  useEffect(() => {
    ...
    userBookingInprogressData
      .getUserBookingInprogressMedium()
      .then((data) => setUserBookingInprogress(data));
  }, []);
  ...
  const BookingId = (res:any) => {
    return (
      ...
      data-bs-target="#inprogress_booking" className="bookbyid">
  ...
  const status = (res:any) => {
    return <span className="badge badge-light-warning">{res.status}</span>;
  };
  const action = () => {
    return (
      <div className="dropdown dropdown-action">
        ...
        <div className="dropdown-menu dropdown-menu-end">
          <Link
            ...
            data-bs-target="#inprogress_booking"
          >
                    ...
                    <div className="booking-lists">
                      <ul className="nav">
                        ...
                        <li>
                          <Link
                            className="active"
                            to={routes.userBookingInprogress}
                          >
                            Inprogress
                          </Link>
                        </li>
