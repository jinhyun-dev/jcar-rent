...
import { userUpcomingData } from "../../core/data/json/user_upcoming";

const UserBookingUpcoming = () => {
  const routes = all_routes;
  const [userUpcoming, setUserUpcoming] = useState([]);
  const [searchInput, setSearchInput] = useState("");
  const filteredData = userUpcoming.filter((booking) => {
  ...
  useEffect(() => {
    ...
    userUpcomingData
      ...
      .then((data) => setUserUpcoming(data));
  }, []);
